...
INSERT INTO nivel (nome, pontuacaototal, descricaotema) VALUES ('Nível 2', 140, 'Programação Intermediária');
...
INSERT INTO tarefa (nome, pontuacao_max, pontuacao_min, descricao, id_nivel) VALUES ('Newbie', 100, 80, 'Nesta Etapa você vai encontrar desafios envolvendo testes de mesa', 2);
INSERT INTO tarefa (nome, pontuacao_max, pontuacao_min, descricao, id_nivel) VALUES ('Amador', 120, 100, 'Agora é hora de solucionar algumas questões de lógica !', 2);
INSERT INTO tarefa (nome, pontuacao_max, pontuacao_min, descricao, id_nivel) VALUES ('Lenda', 150, 120, 'Esta preparado para resolver questões mais dificies sobre teste de mesa e lógica ?', 2);

INSERT INTO tarefa (nome, pontuacao_max, pontuacao_min, descricao, id_nivel) VALUES ('Newbie', 180, 150, 'Nesta etapa você encontrara questões sobre estruturas de condicionais', 3);
INSERT INTO tarefa (nome, pontuacao_max, pontuacao_min, descricao, id_nivel) VALUES ('Amador', 200, 180, 'Nesta etapa você encontrara questões sobre estruturas de repetição', 3);
INSERT INTO tarefa (nome, pontuacao_max, pontuacao_min, descricao, id_nivel) VALUES ('Lenda', 250, 200, 'Nesta etapa é hora de provar que é a Lenda do CodinPlay! ', 3);
...
INSERT INTO atividade (nome, descricaoproblema, pontuacao, respostaa, respostab, respostac, respostad, respostae, respostacerta, tipo, id_tarefa, id_nivel ) VALUES ('Hora do teste','Qual a saída esperada para o codigo abaixo ? <br /> a = 10 <br /> b = 5 <br /> c = a - (a + b) <br /> print(c)" ',20,'20','30','15','7','10',1,1,4,2);
